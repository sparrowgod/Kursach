...
namespace kursovaya
{
    public partial class FormOtdel : Form
    {
        ...
        private void FormOtdel_Load(object sender, EventArgs e)
        {
            ...
            connection.Open();
            string query = "SELECT Имя_отдела, ФИО_заведующего, Название_магазина FROM Otdel, zaved, magazin " +
                "WHERE Otdel.Код_магазина=magazin.Код_магазина AND Otdel.Код_заведующего=zaved.Код_заведующего";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            exApp.Cells[1, 2] = "ФИО заведующего";
            exApp.Cells[1, 3] = "Название магазина";
            int i, j;
